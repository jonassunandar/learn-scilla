...
const l1 = `
## Lesson 1: Deklarasi Kontrak

**Mendeklarasi sebuah kontrak:**

Kita mulai dulu dari yang paling gampang ya.
Pertama kita perlu menggunakan versi solidity yang mana yang akan dipakai dalam sebuah smart contract. Versi solidity harus ditaruh dipaling atas dari code kalian.

Saat tutorial ini dibuat Solidity baru merilis versi 0.6.3. Sehingga sebaiknya kita memakai versi solidity yang paling baru. Jadi bisa kalian tulis:
\`\`\`
pragma solidity 0.6.3;
\`\`\`

Sekarang kita ke fitur utama dari smart contract development. Pertama kita perlu mendeklarasi nama dari kontrak yang nanti akan kita umumkan ke blockchain. Nanti nama ini akan membantu kita untuk mengidentifikasi smart contract.
Format nya gampang banget, tinggal kasi aja nama dari smart contract kalian. Misalnya:

\`\`\`
contract SmartContractPertamaku
\`\`\`

Kalian bisa ubah \`SmartContractPertamaku\` dengan nama smart contract kalian.

## Tugas

1. Tulis versi Solidity yang ingin kalian gunakan(0.6.3)
2. Lalu selanjutkan deklarasi kontrak dengan nama \`SimpleStorage\`
`;
const l2 = `
